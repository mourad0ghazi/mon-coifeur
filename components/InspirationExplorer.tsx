...
const STYLES: Inspiration[] = [
  {
    ...
    why: 'Le fondu libère les côtés et donne une ligne nette. La hauteur du dégradé se choisit selon la forme du visage et la densité des cheveux.', faces: ['ovale', 'carre', 'long'], image: '/images/inspiration-degrade-americain.jpg', diagram: 'fade', service: 'degrade-americain',
  ...
  },
  {
    ...
    why: 'Il laisse de la matière sur les côtés. C’est une option équilibrée pour un visage rond ou cœur et pour ceux qui veulent une coupe facile à entretenir.', faces: ['ovale', 'rond', 'coeur'], image: '/images/inspiration-taper-fade.jpg', diagram: 'taper', service: 'taper-fade',
  ...
  },
  {
    ...
    why: 'La frange réduit visuellement la hauteur du front. Une texture irrégulière adoucit un visage carré, tandis qu’un crop plus court structure un visage ovale.', faces: ['ovale', 'carre', 'long'], image: '/images/inspiration-french-crop.jpg', diagram: 'crop', service: 'degrade-americain',
  ...
  },
  {
    ...
    why: 'La coupe révèle les proportions du crâne et du visage. Une longueur 2 ou 3 est plus douce qu’un zéro et convient mieux aux cheveux clairsemés.', faces: ['ovale', 'carre', 'rond'], image: '/images/inspiration-buzz-cut.jpg', diagram: 'buzz',
  ...
  },
  {
    ...
    why: 'Le dessus légèrement plus long donne de la hauteur sans élargir les joues. C’est une bonne base pour un visage ovale, carré ou long.', faces: ['ovale', 'carre', 'long'], image: '/images/inspiration-crew-cut.jpg', diagram: 'crew',
  ...
  },
  {
    ...
    why: 'La ligne diagonale structure le visage. Une raie souple peut allonger un visage rond et une longueur plus naturelle adoucit une mâchoire carrée.', faces: ['ovale', 'rond', 'carre'], image: '/images/inspiration-side-part.jpg', diagram: 'sidepart',
  ...
  },
  {
    ...
    why: 'La hauteur du dessus allonge un visage rond. Pour un visage long, il vaut mieux réduire la hauteur et garder plus de largeur sur les côtés.', faces: ['rond', 'ovale', 'carre'], image: '/images/inspiration-pompadour.jpg', diagram: 'pompadour',
  ...
  },
  {
    ...
    why: 'La ligne horizontale crée de la largeur. Il convient aux visages longs et ovales ; sur un visage rond, un dessus plus haut et plaqué vers l’arrière affine la silhouette.', faces: ['long', 'ovale', 'rond'], image: '/images/inspiration-undercut.jpg', diagram: 'undercut',
  ...
  },
  {
    ...
    why: 'La longueur arrière donne une ligne verticale aux visages ronds. Un dessus texturé et des côtés maîtrisés peuvent aussi équilibrer un visage carré.', faces: ['rond', 'ovale', 'carre'], image: '/images/inspiration-mullet.jpg', diagram: 'mullet',
  ...
  },
  {
    ...
    why: 'Le volume se place selon le visage : plus haut pour un visage long, plus arrondi pour une mâchoire carrée. L’entretien hydratation et rétrécissement doit être expliqué avant la coupe.', faces: ['long', 'ovale', 'carre'], image: '/images/inspiration-curly-top.jpg', diagram: 'afro',
